...
def train(rank, world_size):
    ...
    optimizer = Adam(ddp_model.parameters(), lr=0.0001)
    ...
    for epoch in range(num_epochs):
        ...
        for batch in loop:
            ...
            outputs = ddp_model(input_ids, token_type_ids=token_ids, attention_mask=attention_mask,
    ...
    torch.save(model.state_dict(), './model/bert-base-cased.pt')
